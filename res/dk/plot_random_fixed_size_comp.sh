...
set output 'dk_random_fixed_size_comp.png'
...
set format x "2^{%L}"
set key left top
plot "ndk_random_bh.dat" using 5:($3/$5) ls 1 with linespoints title 'binary heap' , \
     "ndk_random_fq.dat" using 5:($3/$5) ls 2 with linespoints title 'fibonacci heap'
