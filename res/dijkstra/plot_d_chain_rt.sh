...
plot "sssp_chain_bh.dat" using 1:2 ls 1 with linespoints title 'binary heap', \
     "sssp_chain_fq.dat" using 1:2 ls 2 with linespoints title 'fibonacci heap'
