...
set title "Dijkstra on Random Graph"
set output 'dijkstra_random_rt.png'
...
plot "sssp_random_bh.dat" using 5:2 ls 1 with linespoints title 'binary heap' , \
     "sssp_random_fq.dat" using 5:2 ls 2 with linespoints title 'fibonacci heap'
