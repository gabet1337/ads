...
set title "Inserts (running time)"
...
plot "insert_rb.dat" using 1:($2*1000/$1) ls 1 with linespoints title 'RB', \
     "insert_veb.dat" using 1:($2*1000/$1) ls 2 with linespoints title 'vEB'
