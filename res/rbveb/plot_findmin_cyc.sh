...
set title "FindMin (cycle count)"
set output 'rbveb_findmin_cyc.png'
...
plot "find_min_rb.dat" using 1:6 ls 1 with linespoints title 'RB', \
     "find_min_veb.dat" using 1:6 ls 2 with linespoints title 'vEB'
