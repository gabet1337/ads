...
set title "DeleteMin (comparisons)"
set output 'rbveb_deletemin_br.png'
...
plot "deletemin_rb.dat" using 1:3 ls 1 with linespoints title 'RB', \
     "deletemin_veb.dat" using 1:3 ls 2 with linespoints title 'vEB'
