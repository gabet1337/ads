...
set title "Delete (cycle count)"
set output 'rbveb_delete_cyc.png'
...
plot "delete_rb.dat" using 1:6 ls 1 with linespoints title 'RB', \
     "delete_veb.dat" using 1:6 ls 2 with linespoints title 'vEB'
