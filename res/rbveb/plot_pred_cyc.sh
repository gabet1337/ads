...
set title "PredSearch (cycle count)"
set output 'rbveb_pred_cyc.png'
...
plot "pred_rb.dat" using 1:6 ls 1 with linespoints title 'RB', \
     "pred_veb.dat" using 1:6 ls 2 with linespoints title 'vEB'
