...
set title "Inserts (page faults)"
set output 'rbveb_insert_pf.png'
...
plot "insert_rb.dat" using 1:4 ls 1 with linespoints title 'RB', \
     "insert_veb.dat" using 1:4 ls 2 with linespoints title 'vEB'
