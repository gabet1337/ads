...
set title "Inserts (comparisons)"
set output 'rbveb_insert_br.png'
...
plot "insert_rb.dat" using 1:($3/$1) ls 1 with linespoints title 'RB', \
     "insert_veb.dat" using 1:($3/$1) ls 2 with linespoints title 'vEB'
