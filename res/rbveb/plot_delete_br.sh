...
set title "Delete (comparisons)"
set output 'rbveb_delete_br.png'
...
plot "delete_rb.dat" using 1:3 ls 1 with linespoints title 'RB', \
     "delete_veb.dat" using 1:3 ls 2 with linespoints title 'vEB'
