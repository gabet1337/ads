...
set title "FindMin (comparisons)"
set output 'rbveb_findmin_br.png'
...
plot "find_min_rb.dat" using 1:3 ls 1 with linespoints title 'RB', \
     "find_min_veb.dat" using 1:3 ls 2 with linespoints title 'vEB'
