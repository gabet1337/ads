...
set title "PredSearch (comparisons)"
set output 'rbveb_pred_br.png'
...
plot "pred_rb.dat" using 1:3 ls 1 with linespoints title 'RB', \
     "pred_veb.dat" using 1:3 ls 2 with linespoints title 'vEB'
