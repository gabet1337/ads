...
set title "Inserts (L2 cache miss ratio)"
set output 'rbveb_insert_mr.png'
...
plot "insert_rb.dat" using 1:($7/$6) ls 1 with linespoints title 'RB', \
     "insert_veb.dat" using 1:($7/$6) ls 2 with linespoints title 'vEB'
