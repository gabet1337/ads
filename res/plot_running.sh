...
set format x "2^{%L}"
set key left top
plot "inserts_random_bh.dat" using 1:2 ls 1 with linespoints title 'binary heap' , \
     "inserts_random_fq.dat" using 1:2 ls 2 with linespoints title 'fibonacci heap'
