...
set output 'delmin_del_2_time_random.png'
...
set format x "2^{%L}"
set key left top
plot "random_del_2_bh.dat" using 1:2 ls 1 with linespoints title 'binary heap' , \
     "random_del_2_fq.dat" using 1:2 ls 2 with linespoints title 'fibonacci heap'
