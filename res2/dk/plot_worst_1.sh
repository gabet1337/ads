...
set format x "2^{%L}"
set key left top
plot "bh_worst_1.dat" using 1:4 ls 1 with linespoints title 'binary heap' , \
     "fq_worst_1.dat" using 1:4 ls 2 with linespoints title 'fibonacci heap',\
     "veb_worst_1.dat" using 1:($4/2) ls 3 with linespoints title 'van emde boas'
