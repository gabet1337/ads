...
pair<results,results> deletemin(size_t TEST_RUNS, size_t TEST_SIZE) {
...
void test_deletemin() {
  for (size_t i = 10; i <= 24; i++) {
    size_t test_size = (1<<i);
    pair<results,results> res = deletemin(10,test_size);
    print_results(res.first, "res/rbveb/deletemin_rb.dat");
    print_results(res.second, "res/rbveb/deletemin_veb.dat");    
  }
}

pair<results,results> _delete(size_t TEST_RUNS, size_t TEST_SIZE) {
  ...
  for (size_t i = 0; i < TEST_RUNS; i++) {
    ...
    for (size_t i = 0; i < 1000; i++) {
      //cout << "deleting cand[" << i << "]: " << cand[i] << endl;
      rb->delete_key(cand[i]);
    }
...
void test_delete() {
  for (size_t i = 10; i <= 24; i++) {
    size_t test_size = (1<<i);
    pair<results,results> res = _delete(10,test_size);
    print_results(res.first, "res/rbveb/delete_rb.dat");
    print_results(res.second, "res/rbveb/delete_veb.dat");    
  }
}

pair<results,results> pred_search(size_t TEST_RUNS, size_t TEST_SIZE) {
  ...
  for (size_t i = 0; i < TEST_RUNS; i++) {
    ...
    for (size_t i = 0; i < 1000; i++) {
      cand.push_back(rand.next(16777216));
    }
...
void test_pred_search() {
  for (size_t i = 10; i <= 24; i++) {
    size_t test_size = (1<<i);
    pair<results,results> res = pred_search(10,test_size);
    print_results(res.first, "res/rbveb/pred_rb.dat");
    print_results(res.second, "res/rbveb/pred_veb.dat");    
  }
}
